            ...
            <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <div class="card-body">
                    ...
                    <div class="form-control">
                        ...
                        <input bind:value={data.bpaPublicKey} type="text" placeholder="G..." id="publicKey" class="input input-bordered" disabled />
                    </div>
                    <div class="form-control">
                        <label for="pincode" class="label">
                            <span class="label-text">Pincode</span>
                        </label>
                        <input bind:value={$pincode} type="number" id="pincode" class="input input-bordered" />
                    </div>
