            ...
            <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <div class="card-body">
                    <div class="form-control">
                        ...
                        <input type="text" placeholder="G..." id="publicKey" class="input input-bordered" bind:value={$publicKey} disabled />
                        <label class="label">
                            <button on:click={newKeypair} class="label-text-alt link link-hover">Generate new address?</button>
                        </label>
                    </div>
                    <div class="form-control">
                    ...
                    {#if $showSecret}
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="S..." id="secretKey" class="input input-bordered" bind:value={$secretKey} disabled />
                        </div>
                    {/if}
                    <div class="form-control">
                        ...
                        <input type="number" id="pincode" class="input input-bordered" bind:value={$pincode} />
                    </div>
                    <div class="form-control">
                        <label for="confirmPincode" class="label">
                            <span class="label-text">Confirm Pincode</span>
                        </label>
                        <input type="number" id="confirmPincode" class="input input-bordered" bind:value={$confirmPincode} />
                    </div>
